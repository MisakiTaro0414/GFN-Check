import argparse
import json
from POM.pom import generate_pom
from POM.state_abstraction import sequence_ngram_fn, parent_state_ngram_fn, index_parent_state_ngram_fn
...
def fuzz(oracle, trials, unique_valid, valid, invalid, model, local_search_steps, verbose):
    ...
    for i in progress_bar:
        ...
        tree, num_nodes, validity = generate_pom(oracle, MAX_DEPTH)
        ...
        if model == "LS":
            ...
            for i in range(local_search_steps):
                ...
                new_tree, new_num_nodes, new_validity = generate_pom(
...
if __name__ == '__main__':
    ...
    with open('POM/config.json', 'r') as file:

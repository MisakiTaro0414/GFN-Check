import argparse
import json
from Student.student import generate_student
from Student.state_abstraction import sequence_ngram_fn, parent_state_ngram_fn, index_parent_state_ngram_fn
...
def fuzz(oracle, trials, unique_valid, valid, invalid, model, local_search_steps, verbose):
    ...
    for i in progress_bar:
        ...
        tree, num_nodes, validity = generate_student(oracle, MAX_DEPTH)
        ...
        if model == "LS":
            ...
            for i in range(local_search_steps):
                ...
                new_tree, new_num_nodes, new_validity = generate_student(
